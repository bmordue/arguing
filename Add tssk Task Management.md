...
## Tasks
- [x] Check whether tssk is already in use! If it is, you are done. Ignore the remaining steps
- [x] Install tssk following repository instructions
- [x] Initialize tssk in project root
- [x] Configure tssk for project needs (workflows, statuses, fields)
- [x] Migrate existing tasks from any roadmap/plan/task tracking sources:
...
- [x] Create initial project tasks/backlog
- [x] Set up tssk workflows matching team development process
- [x] Document tssk usage in README or CONTRIBUTING
- [ ] Add tssk commands to developer onboarding guide
- [x] Commit changes with a suitable message
- [x] Open a new pull request
